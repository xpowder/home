    ...
    <form onSubmit={onSubmit} className="my-5 space-y-5" aria-label="Login form" noValidate>
      ...
      <div className="flex items-center justify-between">
        <label className="font-roboto text-subtext flex items-center gap-2 text-[14px] font-normal">
          <input type="checkbox" aria-label="Remember me for next login" /> Remember me
        </label>
      ...
      <LogButton
        ...
        type="submit"
        text={isSubmitting ? t("loggingIn") : "Login"}
      />
      ...
      >
        ...
        <span className="mx-2 whitespace-nowrap">Or continue with</span>
        <div className="bg-gray-300 h-px flex-1" />
      </div>
