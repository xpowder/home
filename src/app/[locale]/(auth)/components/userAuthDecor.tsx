...
export default function UserAuthDecor() {
  ...
  return (
    <div className="relative aspect-[.8] w-[70%]  min-w-[340px] max-w-[500px]  rounded-[60px] border border-white/20 bg-white/20">
      <div className="absolute left-[-30px] top-[70%] flex  h-16 w-16 items-center justify-center rounded-full bg-white rtl:left-auto rtl:right-[-30px]">
      ...
      <div className="relative z-10 space-y-2 p-10">
        <h2 className="font-poppins w-[85%] text-[calc(12px+1vw)] font-bold text-white">
          {t("heading")}
        </h2>
        <p className="font-roboto w-[60%] text-[calc(10px+0.5vw)] font-normal text-white">
          {t("paragraph")}
        </p>
      </div>
    </div>
