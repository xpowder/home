...
import ServiceDetailsCarosel from "./components/serviceDetailsCarosel";
import ServiceDetailsHead from "./components/serviceDetailsHead";
...
export default function ServiceDetailsPage() {
  ...
  const providerId = params.slug as string;
  ...
  const serviceData = {
    ...
    work_time: "3–4 hours", // This could come from provider data if available
